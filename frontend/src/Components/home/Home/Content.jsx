...
export default function Content() {
    return (
        <div className="relative z-10 flex flex-col items-center justify-center min-h-[calc(100vh-80px)] px-6 pt-12 text-center">
            ...
            >
                ...
                >
                    <button
                        ...
                        transition-all duration-300 transform active:scale-95 shadow-lg shadow-cyan-500/10 cursor-pointer max-sm:w-full
            ...
            {/* Stats Footer */}
            <div
                className="mt-20 pt-10 border-t border-white/10 w-full max-w-4xl flex justify-around items-center opacity-50 grayscale hover:grayscale-0
