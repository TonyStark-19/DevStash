    ...
    return (
        <div className="text-white flex flex-col justify-center items-center p-8 h-[75%] font-poppins">
            ...
            <div className="flex flex-col justify-center items-center w-full min-a:pt-10 max-a:pt-5">
                ...
                <h1 className="min-a:text-[55px] max-a:text-[40px] max-b:text-[35px] max-d:text-[30px] max-h:text-[25px]
                ...
                <h2 className="min-a:text-[55px] max-a:text-[40px] max-b:text-[35px] max-d:text-[30px] max-h:text-[25px] mb-2
                font-semibold text-center" data-aos="fade-up" data-aos-delay="200">The Best Dev Resources</h2>

                <p className="min-a:text-[20px] max-a:text-[18px] max-b:text-[16px] max-h:text-[15px] mb-3 min-a:w-[45%]
                ...
                <p className="min-a:text-[20px] max-a:text-[18px] max-b:text-[16px] max-h:text-[15px] min-a:mb-4 max-a:mb-3
                ...
                <div className="flex min-b:flex-row max-b:flex-col max-b:justify-center max-b:items-center gap-4 mt-5"
                    ...
                    <button className="min-a:text-[17px] max-a:text-[15px] max-h:text-[14px] min-a:py-2 max-a:py-1.5 min-a:px-4
                    ...
                    <Link to="/resources">
                        <button className="min-a:text-[17px] max-a:text-[15px] max-h:text-[14px] min-a:py-2 max-a:py-1.5
